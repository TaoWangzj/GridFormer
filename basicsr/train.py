...
def train_pipeline(root_path):
    ...
    if resume_state:  # resume training
        ...
        if 'best_metric' in resume_state:
            logger.info(f"Resuming training from epoch: {resume_state['epoch']}, iter: {resume_state['iter']}, best_metric: {resume_state['best_metric']:.4f}.")
